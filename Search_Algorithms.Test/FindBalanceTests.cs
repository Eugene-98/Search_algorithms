...
namespace Search_Algorithms.Test
{
	public class FindBalanceTests
    {
        ...
        public int FindBalanceElement_Return_IndexOfBalanceElement(int[] array) =>
            FindBalance.FindBalanceElement(array).Value;
        ...
        public int? FindBalanceElement_Return_Null(int[] array)
            => FindBalance.FindBalanceElement(array);

        [Test]
        public void FindBalanceElement_ArrayIsNull_ThrowArgumentNullException() =>
            Assert.Throws<ArgumentNullException>(() => FindBalance.FindBalanceElement(null), message: "Array can not be null.");

        [Test]
        public void FindBalanceElement_ArrayIsEmpty_ThrowArgumentException() =>
            Assert.Throws<ArgumentException>(() => FindBalance.FindBalanceElement(Array.Empty<int>()), message: "Array can not be empty.");
    }
